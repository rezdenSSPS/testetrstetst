...
export function IdCard({ person }: IdCardProps) {
  ...
  return (
    <div className="id-card bg-white rounded-lg shadow-md w-48 h-72 flex flex-col items-center p-3 border border-gray-200 break-inside-avoid">
      ...
      <div className="mt-auto w-full border border-gray-200 bg-gray-50 p-1">
