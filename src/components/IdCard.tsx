...
export function IdCard({ person }: IdCardProps) {
  ...
  return (
    <div className="id-card bg-white rounded-lg shadow-md w-64 h-96 flex flex-col items-center p-4 border border-gray-200 break-inside-avoid">
      <h2 className="text-xl font-bold text-gray-800 mb-2">AIRSOFT CAMP</h2>
      ...
      <h3 className="text-2xl font-semibold text-gray-900 text-center">{person.name}</h3>
      <div className="mt-auto w-full border border-red-200 bg-gray-50 p-2">
        <svg ref={barcodeRef} className="w-full h-10 border border-blue-200"></svg>
